...
def import_data():
    df_ds1 = pd.read_csv("./data/winequality-red.csv", sep=";") # .append(pd.read_csv("winequality-white.csv", sep=";"))
    missing_values = ['?']
    df_ds2 = pd.read_csv("./data/breast-cancer-wisconsin.csv", sep=",",na_values = missing_values)
...
def train_nn_backdrop(__hidden_layer,__learning_rate,max_attempts, X_train, X_test,y_train, y_test,                        __range=range(1000,10000,1000), pop_size=200, mutation_prob=0.2,restarts =0,schedule=mlrose.GeomDecay(),random_state=None) :
    __nn_metrics = {}
    __train_accuracy_values, __test_accuracy_values,__train_time_values, __pred_time_values = [],[],[],[]
...
plot_nn_optimization('train',__range,__nn_metrics_optimization,'Iterations','Accuracy','Optimization - Train Accuracy Vs Itevations','./plot/nn_optimization_train_accuracy_iterations10.png')
plot_nn_optimization('test',__range,__nn_metrics_optimization,'Iterations','Accuracy','Optimization - Test Accuracy Vs Itevations','./plot/nn_optimization_test_accuracy_iterations10.png')
plot_nn_optimization('time',__range,__nn_metrics_optimization,'Iterations','Time','Optimization - Computation Time Vs Itevations','./plot/nn_optimization_time_accuracy_iterations10.png')
...
plot_nn_backdrop('train',__range,__nn_metrics_backdrop,'Iterations','Accuracy','Backprop - Train Accuracy Vs Itevations','./plot/nn_backprop_train_accuracy_iterations10.png')
plot_nn_backdrop('test',__range,__nn_metrics_backdrop,'Iterations','Accuracy','Backprop - Test Accuracy Vs Itevations','./plot/nn_backprop_test_accuracy_iterations10.png')
